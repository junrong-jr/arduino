...
double PID_RPM_R = 0;
double PID_RPM_L = 0;
double setpoint_L = 59.9; //87 59.3  118
...
void fastForward(int grid){ // attempt for faster speed
  initMove();
  pidRPM();
  ticks_to_move = 306 * grid; //306
  speed_L = 335; //268
  speed_R = 352; //280
  setpoint_L = 118; //87 59.3  118
  setpoint_R = 121; //90 60.9  121
...
//    Serial.println(speed_R);
  ...
  setpoint_L = 59.3; //87 59.3  118
  setpoint_R = 60.9; //90 60.9  121
  initEnd();
}
